...
用法示例:
    python novel_workflow.py status --project D:/AiProject/Node/projects/<novel-name>
    python novel_workflow.py generate --project D:/AiProject/Node/projects/<novel-name> --start 1 --end 100
    python novel_workflow.py review --project D:/AiProject/Node/projects/<novel-name>
    python novel_workflow.py repair --project D:/AiProject/Node/projects/<novel-name> --mode draft --limit 50
    python novel_workflow.py notify --project D:/AiProject/Node/projects/<novel-name>
    python novel_workflow.py resume --project D:/AiProject/Node/projects/<novel-name>

也可通过环境变量设置默认项目:
    set NOVEL_PROJECT_DIR=D:/AiProject/Node/projects/<novel-name>
...
def run(script: str, project: str, args: list[str]) -> int:
    cmd = [sys.executable, str(script_path(script)), "--project", project, *args]
    print(f"$ {' '.join(cmd)}")
