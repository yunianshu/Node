...
"""
Writer Agent - 配置驱动版
根据项目 config.json 和 prompts/writer.txt 生成章节内容
"""
import json
import sys
...
def main():
    ...
    logger = get_logger("Writer", config.logs_dir)

    logger.info("=" * 60)
    logger.info("Writer Agent 启动")
    logger.info("=" * 60)
    ...
    result = generate_chapter(args.chapter, client, config, world_data, outline,
